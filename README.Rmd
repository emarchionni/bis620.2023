...
This is a package that integrates a shiny app for data visualization for the ctrialsgov database that can be found at the [link](www.github.com/presagia-analytics/ctrialsgov). This database includes the history, along with extensive other variables, of the clinical trials conducted worldwide for any type drug since 1995. 
